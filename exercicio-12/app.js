...
let menssage = 'Segundo o site Omelete, os melhores filmes de 2019 são:';

best2019Movies.forEach((bestMovie) =>{
  menssage += `
  - ${bestMovie.title}, dirigido por ${bestMovie.directedBy}`;
});
...
const youtubeUser = {
  ...
  listVideos(){
    ...
    this.videos.recentVideos.forEach((titleVideos) =>{
      console.log(titleVideos.title);
    });
  }
}

youtubeUser.listVideos();
