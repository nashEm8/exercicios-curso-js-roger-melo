...
const convertedName = ([myName[0].toUpperCase(), ...myName.slice(1)].join(''));
...
const manipulationSlide = currentSlideIndex => {
...
backButton.addEventListener('click', () => {  
  ...
  manipulationSlide(currentSlideIndex);
});
